...
/**
 * @Title: ZyblogsAuthenticationFailHandler.java
 * @Package cn.zyblogs.security.browser.authentication
 * @Description: TODO 登陆失败处理器
 * @Author ZhangYB
 * @Version V1.0
 */
@Component("zyblogsAuthenticationFailHandler")
@Slf4j
public class ZyblogsAuthenticationFailHandler extends SimpleUrlAuthenticationFailureHandler {
